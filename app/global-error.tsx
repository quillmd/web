    ...
    <div className="flex flex-row items-center justify-center min-h-screen bg-orange-200 flex-wrap">
      <div className="text-center mr-8 flex flex-col items-center">
        ...
        <div className="flex justify-center space-x-4 mb-8">
          <Link href="/help">
            <div
              style={{ width: "75.14px", height: "40px" }}
              className="bg-amber-500 text-white flex items-center justify-center rounded-md hover:bg-amber-600 cursor-pointer"
            >
              Help
            </div>
          </Link>
          <Link href="/">
            <div
              style={{ width: "75.14px", height: "40px" }}
              className="bg-gray-300 text-gray-700 flex items-center justify-center rounded-md hover:bg-gray-400 cursor-pointer"
            >
              Home
            </div>
          </Link>
