...
export default function Landing() {
  ...
  return (
    <div className="font-garamond overflow-x-hidden snap-y snap-mandatory h-screen overflow-scroll">
      ...
      <section className="py-36 px-6 md:text-center h-screen snap-start">
        <h2 className="text-4xl font-bold mb-12 text-center">
          How Quill Works
        </h2>
        <div className="grid grid-cols-1 md:grid-cols-3 md:gap-20 max-w-6xl mx-auto h-full">
          <div>
      ...
      <div className="h-screen snap-start">
        <section className="max-w-full px-6 h-full flex flex-col justify-center">
