    ...
    <html lang="en" className={cn(inter.variable, garamond.variable)}>
      <body className="max-w-screen min-h-screen flex flex-col">
            ...
            <ul className="hidden md:flex">
              ...
              <li className="hidden md:block">
                <Button
                  ...
                  asChild
                >
                  <NextLink href={"/login"}>Logout</NextLink>
                </Button>
              </li>
            </ul>
              ...
              */}
              <li>
                <Button
                  ...
                  asChild
                >
                  <NextLink href={"/pricing"} onClick={toggleMenu}>
                    Pricing
                  </NextLink>
                </Button>
              </li>
              <li>
                <Button
                  ...
                  asChild
                >
                  <NextLink href={"/about"} onClick={toggleMenu}>
                    About us
                  </NextLink>
                </Button>
              </li>
        ...
        <div className="flex-grow">
          <main className="font-garamond overflow-x-hidden">{children}</main>
        </div>
