      ...
      <main className="flex flex-col items-center justify-start pt-24 px-6 md:px-0">
        <div className="max-w-3xl">
          ...
          <p className="text-xl mb-12">
            {`Quill does NOT retain audio recordings. Quill creates notes for physicians’ eyes only by
          ...
          <p className="text-xl mb-12">
            ...
            a business model that includes making money from selling your personal data.`}
          </p>
          <p className="text-xl mb-12">
            ...
            with patient consent. If we have an opportunity to include your personal data
            in our research, we will request your consent before we do so.`}
          </p>
          <p className="text-xl mb-12">
            {`Data Security is not a trade-off. You trust us to keep your personal data
