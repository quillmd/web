    ...
    <main className="px-8 flex flex-col gap-48">
      <section className="w-full h-svh flex flex-col-reverse items-center md:flex-row justify-center gap-4 pb-24">
        <div className="flex flex-col gap-2 md:gap-6 max-w-2xl text-center md:text-left">
          <h1 className="text-3xl md:text-6xl font-bold">Introducing MedSquire:</h1>
          <h1 className="text-3xl md:text-6xl font-bold">
            Effortless Documentation for the Modern Physician
          </h1>
          <span className="text-xl md:text-3xl">
            MedSquire is an AI scribe that listens to doctor-patient interactions
          ...
          <div className="flex justify-center md:justify-start">
            <Button
              ...
              asChild
            >
              <NextLink href={"/login"}>Try MedSquire</NextLink>
            </Button>
          </div>
        </div>
        ...
        <div className="flex flex-col md:grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          <div>
            ...
            <p className="text-base md:text-2xl">
              MedSquire is introduced and everyone in the room agrees to let it
              scribe. Like a human scribe, MedSquire listens and doesn&apos;t save
              audio.
            </p>
          </div>
          <div>
            ...
            <p className="text-base md:text-2xl">
              MedSquire listens to the conversation and writes the draft based on
          ...
          <div>
            ...
            <p className="text-base md:text-2xl">
              The scribed note draft is available on the MedSquire website. Copy and
      ...
      <section className="w-full h-svh md:h-96 flex flex-col md:flex-row flex-wrap justify-center items-center gap-8 md:mb-48">
        <div className="space-y-2 max-w-md">
          ...
          <p className="text-base md:text-2xl">
            {`Have a new feature idea or want to know something about the project? Know someone who could benefit from MedSquire? Tell us.`}
          </p>
        </div>
        <div>
          <ContactUsForm />
