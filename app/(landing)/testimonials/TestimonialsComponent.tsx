...
export default function TestimonialsComponent() {
  ...
  const testimonials: Testimonial[] = [
    ...
    },
    {
      ...
      rating: 5,
      date: "Oct 6, 2023",
      text: "I have been using MedSquire for about a month now, totally changed my everyday experience. I am no longer bothered by charting, having more time to spend with patients, seeing more patients, and going home on time. I highly recommend this app. It gives me peace of mind. It literally resolved my carpet tunnel cause apparently that's how much I was typing in the past.",
    },
